...
)
{
    ...
    lines.push_back("RK3568 C++ RKNN Person Detection");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "detect_every : " << detect_every << " frames" << std::endl;
    ...
    try {
        ...
        std::string window_name = "RK3568 C++ RKNN LCD Detection";
        ...
        while (true) {
            ...
            draw_overlay(frame, last_detections, camera_fps, last_infer_ms, frame_count);
